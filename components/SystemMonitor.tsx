...
export function SystemMonitor() {
  ...
  // Preluăm starea ferestrelor deschise în "Web OS"
  ...
  return (
    <div className="space-y-6 text-zinc-300 font-mono select-none overflow-y-auto max-h-[85vh] scr">
      ...
      {/* SECȚIUNEA PENTRU PROCESE (TASK MANAGER) */}
      <div className="mt-6 space-y-2">
         ...
         <div className="space-y-2">
           ...
           {/* Ferestrele Deschise  */}
           {windows && windows.length > 0 ? windows.map((win: any) => {
              // Generăm niște consum random, dar determinist în funcție de nume, ca să pară real
